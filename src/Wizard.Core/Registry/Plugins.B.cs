...
public static partial class Plugins
{
    ...
    [
        new()
        {
            ...
            Category = PluginCategory.Mocking,
        ...
        new()
        {
            ...
            [
                    ...
                    """)
                {
                    Comment =
                    [
                        "Nothing in the test names the comparer: it is registered for the png plugin, so every",
        ...
        new()
        {
            ...
            [
                ...
                {
                    // Not emitted for the pdf-only role, where another plugin owns the comparers.
            ...
            [
                new(
                    ...
                    [
                        ...
                        new("comparer-only", "Compare images only", "Another plugin renders pdf, and is initialized after this one so its converter wins."),
                        new("pdf-only", "Render pdf to png only", "Another plugin registers the image comparers, so no RegisterComparers call is generated.")
                    ]),
                new(
        ...
        new()
        {
            ...
            [
                ...
                "The stream converters cover bmp, gif, jpg, png and tif, so a png another plugin rendered is re-encoded by ImageSharp before it is written.",
        ...
        new()
        {
            ...
            [
                new(
                    ...
                    "plugin, and Initialize() would otherwise get in first with the default threshold of 5."),
                new(
        ...
        new()
        {
            ...
            [
                ...
                "Every logging plugin records under the name `log`, so entries from two of them interleave and `Recording.IgnoreNames` cannot separate them.",
        ...
        new()
        {
            ...
            Notes =
            [
                "The `HttpMock` fluent API comes from the Mockly package; this plugin only teaches Verify how to write the results.",
                ...
                "The only plugin here that targets net472."
            ]
        },
        new()
        {
