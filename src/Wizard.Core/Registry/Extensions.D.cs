...
public static partial class Extensions
{
    ...
    /// <summary>Entries researched in plan-research/extension-catalogue-D.md.</summary>
    static IReadOnlyList<ExtensionDefinition> CatalogueD =>
    [
        new()
        {
            Id = "LocalDb",
            ...
            [
                    ...
                    """)
                {
                    ...
                    [
                        ...
                        "and it names the workbook type rather than inferring it from an extension."
                    ]
                },
                new(
                    "WriterOptions",
        ...
        new()
        {
            ...
            [
                ...
                "Rendered png differs slightly between machines; the extension's own tests call `VerifierSettings.UseSsimForPng(.7)` to tolerate it.",
        ...
        new()
        {
            ...
            [
                    ...
                    """")
                {
                    Comment =
                    [
                        "Without this extension a JsonDocument serializes as its internal structure. With it the",
        ...
        new()
        {
            ...
            Category = ExtensionCategory.Tooling,
        ...
        new()
        {
            ...
            Notes =
            [
                "The only output is a png; there is no text snapshot, so an exact byte comparison is brittle. `VerifierSettings.UseSsimForPng()` or an image comparer extension makes it tolerant.",
        ...
        new()
        {
            ...
            [
                    ...
                    """)
                {
                    ...
                    [
                        ...
                        // appender the extension installed is what captures the messages.
            ...
            [
                ...
                "Every logging extension records under `log`, so entries from two of them interleave and `Recording.IgnoreNames` cannot separate them (plan A12).",
