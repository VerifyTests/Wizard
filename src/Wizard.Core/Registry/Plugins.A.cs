public static partial class Plugins
{
    ...
    static IReadOnlyList<PluginDefinition> CatalogueA =>
    [
        new()
        {
            Id = "AngleSharp",
            ...
            Notes =
            [
                "This plugin compares and scrubs; it never produces a new snapshot target of its own.",
        ...
        new()
        {
            ...
            Notes =
            [
                "`VerifierSettings.InitializePlugins()` cannot enable this plugin: its plugin type is internal, which is why the module initializer forces `Render`'s static constructor instead.",
        ...
        new()
        {
            ...
            [
                ...
                "This is most useful alongside a ui plugin: a view model verified on its own otherwise hides what its commands do."
            ]
        },
        new()
        {
