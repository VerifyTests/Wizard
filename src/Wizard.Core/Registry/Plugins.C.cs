public static partial class Plugins
{
    ...
    /// <summary>Entries researched in plan-research/plugin-catalogue-C.md.</summary>
    static IReadOnlyList<PluginDefinition> CatalogueC =>
    [
        new()
        {
            Id = "NewtonsoftJson",
        ...
        new()
        {
            ...
            [
                    ...
                    """)
                {
                    Comment =
                    [
                        "A fixed date is worth reading in full. DontScrubNodaTimes turns this plugin off for the",
        ...
        new()
        {
            ...
            [
                    ...
                    """)
                {
                    ...
                    [
                        ...
                        "there is no Verify specific api for them, only the converter this plugin registers.",
            ...
            [
                ...
                "Activities land in the shared recording under `activity`; other recording plugins add their own entries to the same snapshot.",
        ...
        new()
        {
            ...
            [
                ...
                {
                    SkipReason = "needs pandoc installed and a sample.docx in the test project's output directory.",
                    Comment = ["The same converter runs for a stream, with the plugin naming the input format."]
                },
                new(
                    "RtfStream",
                    """
            ...
            Notes =
            [
                "The supported inputs are docx and rtf. Both produce one `md` target, so this never collides with the pdf or image plugins.",
                ...
                "It owns the `docx` converter, so it cannot be combined with another plugin that also converts docx.",
        ...
        new()
        {
            ...
            [
                    ...
                    """)
                {
                    ...
                    [
                        ...
                        // fixture file. System.Drawing is why this plugin is Windows only.
            ...
            [
                ...
                "`RegisterComparer` also takes threshold, sigma, gamma and angles, so a second plugin can be registered with its own tuning.",
        ...
        new()
        {
            ...
            Notes =
            [
                "The converter is inserted at index 0, so it wins over any other converter that handles `Expression`, including one an ORM plugin registers.",
        ...
        new()
        {
            ...
            Notes =
            [
                "It registers serializer converters only, with no file extension converter, so it cannot collide with a format based plugin.",
        ...
        new()
        {
            ...
            [
                ...
                "Entries land in the shared recording under `log`, which is the name every logging plugin uses, so `Recording.IgnoreNames` cannot tell them apart.",
