...
{
    static readonly UTF8Encoding withBom = new(encoderShouldEmitUTF8Identifier: true);
    static readonly UTF8Encoding withoutBom = new(encoderShouldEmitUTF8Identifier: false);
