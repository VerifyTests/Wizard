public class SponsorRulesTests
{
    ...
    public Task Validation() =>
        Verify(
            new Dictionary<string, IReadOnlyList<string>>
            {
                ...
                ["sponsor, future start"] =
                    Errors(
                        new()
                        {
                            SponsorMode = SponsorMode.Sponsor,
                            SponsorAccount = "acme",
                            SponsorshipStart = new Date(2026, 10, 1)
                        }),
                ["sponsor, private too far"] =
                    Errors(
                        new()
                        {
                            SponsorMode = SponsorMode.Sponsor,
                            SponsorAccount = "acme",
                            SponsorshipPrivateUntil = "2027-10"
                        }),
                ["sponsor, valid"] = Errors(
                    new()
                    {
                        SponsorMode = SponsorMode.Sponsor,
                        SponsorAccount = "acme",
                        SponsorshipStart = GeneratorTests.Today
                    }),
                ["exempt, none chosen"] =
                    Errors(
                        new()
                ...
                ["exempt, expired"] =
                    Errors(
                        new()
                        {
                            ...
                            SponsorUntil = "2026-08"
                        }),
                ["exempt, current month"] =
                    Errors(
                        new()
                        {
                            SponsorMode = SponsorMode.Exempt,
                            Exemption = Exemption.OpenSource,
                            SponsorUntil = "2026-09"
                        }),
                ["exempt, consulting past 6 months"] =
                    Errors(
                        new()
                        {
                            SponsorMode = SponsorMode.Exempt,
                            Exemption = Exemption.MaintainerConsulting,
                            SponsorUntil = "2027-04"
                        }),
                ["exempt, open source 12 months"] =
                    Errors(
                        new()
                        {
                            SponsorMode = SponsorMode.Exempt,
                ...
                ["private arrangement, bad format"] =
                    Errors(
                        new()
                        {
                            SponsorMode = SponsorMode.PrivateArrangement,
                            SponsorUntil = "Sept 2027"
                        }),
                ["decide later"] = Errors(
                    new()),
                ["ignore"] = Errors(
    ...
    public async Task DefaultsFillTheMaximumTerm()
    {
        ...
        var consulting = new WizardState
        {
            SponsorMode = SponsorMode.Exempt,
            Exemption = Exemption.MaintainerConsulting
        };
