...
Generated by the [Verify wizard](https://verifytests.github.io/Wizard/new?step=output&os=Windows&ide=Rider&cli=Cli&tf=MSTest&ci=GitHubActions&sponsor=Exempt&exempt=OpenSource&until=2027-09). This project was set up with Verify snapshot testing; the facts below describe that setup.
 ...
 * Verify packages: Verify.MSTest 33.1.1, Verify.DiffPlex 3.3.1.
