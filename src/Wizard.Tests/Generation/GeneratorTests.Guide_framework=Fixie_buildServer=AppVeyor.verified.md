...
Generated by the [Verify wizard](https://verifytests.github.io/Wizard/new?step=output&os=Windows&ide=Rider&cli=Cli&tf=Fixie&ci=AppVeyor&sponsor=Exempt&exempt=OpenSource&until=2027-09) (reopen that link to change any answer).

 * Operating system: Windows
 * IDE: JetBrains Rider
 * Package management: Prefer CLI
 * Test framework: Fixie
 * Build server: AppVeyor
 * Extensions: DiffPlex (verbose)
 * Maintenance fee: Exempt: OpenSource
 * .NET: net10.0 (SDK 10.0.401)
 * Package versions: the newest stable releases as of 2026-09-22; nuget.org was not checked when this was generated
...
The solution's `appveyor.yml` builds, runs the tests, and includes this step.
