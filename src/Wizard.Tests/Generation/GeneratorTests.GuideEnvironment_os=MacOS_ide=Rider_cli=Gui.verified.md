...
Generated by the [Verify wizard](https://verifytests.github.io/Wizard/new?step=output&os=MacOS&ide=Rider&cli=Gui&tf=XunitV3&ci=GitHubActions&sponsor=Exempt&exempt=OpenSource&until=2027-09) (reopen that link to change any answer).
...
```xml
<ItemGroup>
  <PackageVersion Include="Verify.XunitV3" Version="1.0.0" />
  <PackageVersion Include="xunit.v3" Version="1.0.0" />
  <PackageVersion Include="Verify.DiffPlex" Version="1.0.0" />
</ItemGroup>
```
