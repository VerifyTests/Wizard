...
Generated by the [Verify wizard](https://verifytests.github.io/Wizard/new?step=output&os=Windows&ide=Rider&cli=Cli&tf=TUnit&ci=AppVeyor&sponsor=Exempt&exempt=OpenSource&until=2027-09) (reopen that link to change any answer).
...
TUnit sets up the test project as a Microsoft.Testing.Platform app itself, so no project settings are needed.
