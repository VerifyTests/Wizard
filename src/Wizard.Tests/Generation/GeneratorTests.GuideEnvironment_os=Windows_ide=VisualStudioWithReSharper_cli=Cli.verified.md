...
Generated by the [Verify wizard](https://verifytests.github.io/Wizard/new?step=output&os=Windows&ide=VisualStudioWithReSharper&cli=Cli&tf=XunitV3&ci=GitHubActions&sponsor=Exempt&exempt=OpenSource&until=2027-09) (reopen that link to change any answer).

 * Operating system: Windows
 * IDE: Visual Studio with ReSharper
